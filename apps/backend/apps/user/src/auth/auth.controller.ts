import { ApiCustomResponse } from '@libs/common/decorators/swagger';
import { BaseException } from '@libs/common/exceptions';
import {
  Body,
  Controller,
  Get,
...
export class AuthController {
  ...
  async googleLoginCallback(@UserInfo() userInfo: JwtPayload) {
    ...
    return this.authService.googleLogin(userInfo as any);
  }
}
